		...
		$meta_box = array(
			...
			'fields' => array(
				array(
					...
					'label' => __('Header Style','noo'),
					'desc'	=> __('Select page header style','noo'),
					'type'	=> 'select',
					'std'   => 'header',
					'options'=> array(
						array('value' =>'header','label'=>'Using header in customizer'),
						array('value' =>'header1','label' => 'Header Default'),
						array('value' =>'header2','label' => 'Header Transparent'),
					)
				),
				array(
					'type' => 'divider'
				...
				array(
					...
					'label' => __("Logo Sticky",'noo'),
					'desc'	=> __("Logo Sticky",'noo'),
					'type' 	=> 'image',
				),
				array(
				...
				array(
					...
					'id' => "{$prefix}_hide_page_title_text",
					'type' => 'checkbox',
				),
				array(
					'label' => __('Hide Header', 'noo') ,
					'id' => "{$prefix}_hide_header",
					'type' => 'checkbox',
				),
				array(
					'label' => __('Hide Footer', 'noo') ,
					'id' => "{$prefix}_hide_footer",
					'type' => 'checkbox',
				),
			)
		);
