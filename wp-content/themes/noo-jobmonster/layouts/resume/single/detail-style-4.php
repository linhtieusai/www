...
?>
<article id="post-<?php the_ID(); ?>" class="resume-style-4">
				...
				<div class="resume-desc">
			                        ...
			                        ?>
			                             <form method="post">
			                               <span class="show-candidate-contact "
			                                     ...
			                                     data-toggle="tooltip"
			                                     title="<?php echo esc_html__($remain_view_candidate_contact); ?>">
					...
					<?php if( $enable_education ) : ?>
						...
						<?php if( !empty( $education['school'] ) ) : ?>
							<div class="resume-timeline">
								<div class="icon-general education"></div>	
					...
					<?php if( $enable_experience ) : ?>
						...
						<?php if( !empty( $experience['employer'] ) ) : ?>
							<div class="resume-timeline">
								<div class="icon-general building"></div>				
                                    ...
                                    <?php
                                        foreach ( $portfolio_arr as $image_id ) :
                                            ...
                                            if(isset($image[0]) && !empty($image[0])){
                                            	echo '<a class="col-md-3 col-sm-3 col-xs-6" href="' . $image_full[0] . '"><img src="' . esc_url( $image[0] ) . '" alt="*" /></a>';
                                            }
...
<?php 
	if($action != 'resume_preview'):?>
		<div class="row resume-details-4">
		    <?php
