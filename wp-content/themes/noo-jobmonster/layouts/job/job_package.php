                ...
                <div class="<?php echo $product->get_slug(); ?> noo-pricing-column <?php echo 'col-sm-6 col-md-' . $columns_class; ?> <?php echo($product->is_featured() ? 'featured' : ''); ?>">
                    <div class="pricing-content">
                        <div class="pricing-header">
                            ...
                            <h3 class="pricing-value"><span class="noo-price"><?php echo wp_kses_post($product->get_price_html()); ?></span>
                            </h3>
                        </div>
                        <div class="pricing-info">
                            <ul class="noo-ul-icon fa-ul">
                                <?php if (!empty($package_interval_text)) : ?>
                                    <li class="noo-li-icon job-package-interval">
                                    	<i class="fa fa-check-circle"></i> <?php echo sprintf(__('%s Membership', 'noo'), $package_interval_text); ?>
                                    </li>
                                <?php endif; ?>
                                <?php if ($is_unlimited || $job_limit > 0) : ?>
                                    <li class="noo-li-icon job-posting">
                                    	<i class="fa fa-check-circle"></i> <?php echo esc_html($job_posting_text); ?>
                                    </li>
                                <?php elseif(noo_package_show_no_support_feature()) : ?>
                                    <li class="noo-li-icon job-posting noo-li-not-good">
                                    	<i class="far fa-times-circle not-good"></i> <?php esc_html_e('Job posting', 'noo'); ?>
                                    </li>
                                <?php endif; ?>
                                <?php if ($featured_limit > 0) : ?>
                                    <li class="noo-li-icon featured-job">
                                    	<i class="fa fa-check-circle"></i> <?php echo esc_html($job_featured_text); ?>
                                    </li>
                                <?php elseif(noo_package_show_no_support_feature()) : ?>
                                    <li class="noo-li-icon featured-job noo-li-not-good">
                                    	<i class="far fa-times-circle not-good"></i> <?php esc_html_e('Featured job', 'noo'); ?>
                                    </li>
                                <?php endif; ?>
                                <?php if ($refresh_limit > 0) : ?>
                                    <li class="noo-li-icon job-refresh">
                                    	<i class="fa fa-check-circle"></i> <?php echo esc_html($job_refresh_text); ?>
                                    </li>
                                <?php elseif(noo_package_show_no_support_feature()) : ?>
                                    <li class="noo-li-icon job-refresh noo-li-not-good">
                                    	<i class="far fa-times-circle not-good"></i> <?php esc_html_e('Refresh job', 'noo'); ?>
                                    </li>
                                <?php endif; ?>
                                <?php if($download_resume_limit == 99999999): ?>
                                    <li class="noo-li-icon download-resume">
                                    	<i class="fa fa-check-circle"></i><?php esc_html_e('Unlimited download resume', 'noo'); ?>
                                    </li>
                                <?php elseif($download_resume_limit == 'not_download'): ?>
                                 	<?php if(noo_package_show_no_support_feature()):?>
                                    <li class="noo-li-icon download-resume noo-li-not-good">
                                    	<i class="far fa-times-circle not-good"></i><?php esc_html_e('Download Resume Attach file','noo') ?>
                                    </li>
                                	<?php endif; ?>
                                <?php elseif($download_resume_limit == 'not_package'): ?>
                                <?php else: ?>
                                    <li class="noo-li-icon download-resume">
                                    	<i class="fa fa-check-circle"></i><?php echo sprintf(_n('%s download resume ','%s download resumes ',$download_resume_limit,'noo'),$download_resume_limit); ?>
                                    </li>
                                <?php endif; ?>
                                <?php if ($is_unlimited || $job_limit > 0) : ?>
                                    <li class="noo-li-icon job-duration">
                                    	<i class="fa fa-check-circle"></i> <?php echo esc_html($job_duration_text); ?>
                                    </li>
                                <?php endif; ?>
                                <?php if ($company_featured) : ?>
                                    <li class="noo-li-icon">
                                    	<i class="fa fa-check-circle"></i> <?php esc_html_e('Featured Company', 'noo'); ?>
                                    </li>
                                <?php endif; ?>
                                <?php 
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-7 pull-right pricing-info">
                                                    <ul class="noo-ul-icon fa-ul">
                                                        <?php if (!empty($package_interval_text)) : ?>
                                                            <li class="noo-li-icon job-package-interval"><i class="fa fa-check-circle"></i> <?php echo sprintf(__('%s Membership', 'noo'), $package_interval_text); ?>
                                                            </li>
                                                        <?php endif; ?>
                                                        <?php if ($is_unlimited || $job_limit > 0) : ?>
                                                            <li class="noo-li-icon"><i class="fa fa-check-circle"></i> <?php echo $job_posting_text; ?>
                                                            </li>
                                                        <?php elseif(noo_package_show_no_support_feature()) : ?>
                                                            <li class="noo-li-icon noo-li-not-good"><i class="far fa-times-circle not-good"></i> <?php echo __('No job posting', 'noo'); ?>
                                                            </li>
                                                        <?php endif; ?>
                                                        <?php if ($featured_limit > 0) : ?>
                                                            <li class="noo-li-icon"><i class="fa fa-check-circle"></i> <?php echo $job_featured_text; ?>
                                                            </li>
                                                        <?php elseif(noo_package_show_no_support_feature()) : ?>
                                                            <li class="noo-li-icon noo-li-not-good"><i class="far fa-times-circle not-good"></i> <?php echo __('No featured job', 'noo'); ?>
                                                            </li>
                                                        <?php endif; ?>
                                                        <?php if ($is_unlimited || $job_limit > 0) : ?>
                                                            <li class="noo-li-icon"><i class="fa fa-check-circle"></i> <?php echo $job_duration_text; ?>
                                                            </li>
                                                        <?php endif; ?>
                                                        <?php if ($company_featured) : ?>
                                                            <li class="noo-li-icon"><i class="fa fa-check-circle"></i> <?php echo __('Featured Company', 'noo'); ?>
                                                            </li>
                                                        <?php endif; ?>
