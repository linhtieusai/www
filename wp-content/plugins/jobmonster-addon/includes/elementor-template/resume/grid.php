...
$item_class = $is_slider == 'true' ? 'swiper-slide' : 'noo-grid-item';
...
?>
    <div class="noo-resumes-slider noo-swiper" id="<?php echo($id_resume); ?>" <?php echo $data_slide ?>>
        <?php if ($wp_query->have_posts()): ?>
            <ul class=" swiper-wrapper noo-resume-<?php echo esc_attr($display_type) ?> <?php echo esc_attr( $mobile_class . ' ' .$tablet_class.' '.$desktop_class) ;?>" >
